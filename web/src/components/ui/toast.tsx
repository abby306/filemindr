...
export function Toast({
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-4 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-full border border-border bg-p-900 px-4 py-2.5 text-on-ink shadow-e3"
    >
